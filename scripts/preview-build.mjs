 ...
 * the page stays file://-safe (no module scripts). Mirrors how the app actually
 * ships: open index.html directly, no bundler.
 */
import { readFileSync, mkdirSync, copyFileSync, rmSync, existsSync } from "node:fs";

const ASSETS = ["index.html", "styles.css", "app/model.js", "app/main.js"];
const OUT = "dist";
...
for (const ref of ["styles.css", "app/model.js", "app/main.js"]) {
