...
const mustReference = ["app/presets.js", "app/episode.js", "app/preview.js", "app/export.js", "app/ui.js", "app/styles.css"];
...
if (!html.includes('id="export"')) {
  console.error("preview-build: index.html must include the Export episode video control");
  process.exit(1);
}
