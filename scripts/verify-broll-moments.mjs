...
// speaker colors), present at 3.5s, absent again at 6s — and that switching
...
async function main() {
  ...
  try {
    ...
    console.log("verify-broll-moments: OK — timed b-roll PNG renders only inside 2-5s across Split/Stack and is burned into the export (absent at 1s/6s, present at 3.5s)");
