...
### Currently accepted
Current accepted work: **#98 Keep the selected layout when canceling customization**. A PR must complete that issue's Acceptance through the normal product workflow.
